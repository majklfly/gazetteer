    ...
    !(function() {
        ...
        (b.prototype.isVideo = function(a, b) {
            ...
            if (
                ((c = this.s.dynamic ?
                    ...
                    this.$items.eq(b).attr("data-html")), !a)
            )
                return c ?
                    { html5: !0 } :
                    (console.error(
                ...
                (this.s.dynamic ?
                    ...
                    ((d = this.$items.eq(b)),
                        ...
                        ((e = d.attr("data-sub-html")),
                            ...
                            !e &&
                            (e =
                                d.attr("title") || d.find("img").first().attr("alt")))), !c)
            )
                if (void 0 !== e && null !== e) {
        ...
        (b.prototype.loadContent = function(b, c, d) {
            ...
            l.$slide
                ...
                q && q.html5 && !m && l.$slide.eq(b).addClass("lg-complete"), !0 === c &&
        ...
        (b.prototype.touchMove = function(b, c) {
            ...
            Math.abs(d) > 15 &&
                (this.$outer.addClass("lg-dragging"),
                    ...
                    this.setTranslate(
                        a(".lg-prev-slide"), -this.$slide.eq(this.index).width() + d,
                        0
                    ),
                    this.setTranslate(
                        a(".lg-next-slide"),
        ...
        (c.prototype.build = function() {
            ...
            d.core.$outer.find(".lg-thumb").html(e),
                ...
                c.each(function() {
                    ...
                    c &&
                        a.getJSON(
                            "//www.vimeo.com/api/v2/video/" + c + ".json?callback=?", { format: "json" },
                            function(a) {
        ...
        (d.prototype.zoomDrag = function() {
            ...
            c.core.$slide.on("mousedown.lg.zoom", function(e) {
                ...
                a(window).on("mouseup.lg.zoom", function(a) {
                    f &&
                        ((f = !1),
                            c.core.$outer.removeClass("lg-zoom-dragging"), !g ||
                            (d.x === e.x && d.y === e.y) ||
                            ((e = c.getDragCords(a, Math.abs(j))),
